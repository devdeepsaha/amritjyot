...
export default function Hero() {
  return (
    <section className="relative min-h-[calc(100svh-56px)] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-container-max mx-auto px-gutter w-full pt-6 md:pt-12 pb-32 md:pb-32">
        <div className="max-w-2xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-sm max-w-lg mb-md md:mb-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-md">
            <a
              className="bg-primary text-on-primary px-lg py-sm md:py-md rounded-xl font-headline-md text-headline-md text-center hover:shadow-lg transition-all flex items-center justify-center gap-2"
              href="#appointment"
            >
              Book an Appointment
      ...
      <TrustBar className="absolute inset-x-0 bottom-0 z-20" />
    </section>
  );
}
